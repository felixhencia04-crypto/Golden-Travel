...
import { Check, UploadCloud, Plus, Minus, X, Image as ImageIcon, ArrowRight } from 'lucide-react';
...
export default function RegistrationStepper({ 
  ...
  isDocumentPending,
  onNavigate,
  selectedPackageName = "Paket Umroh Plus Turki 12 Hari",
  paxCount = 3,
  ...
  const handleKonfirmasi = () => {
    if (tempPkg) {
      ...
      // Auto-Advance Logic
      // Setelah paket dipilih, bisa memanggil fungsi parent untuk auto-advance
    }
  };
            ...
            <div className="mt-4 bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
              ...
              {(isActive || pendingPaymentStep === 'dp1') && (
                <button 
                  ...
                  className="mt-5 w-full flex items-center justify-center gap-2 bg-gray-900 hover:bg-black text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-colors shadow-sm"
                >
  ...
  const catalog = [
    { name: 'Paket Umroh Plus Turki 12 Hari', date: '25 Agustus 2026', price: 36000000, quota: 12 },
    { name: 'Umroh Reguler 9 Hari', date: '10 September 2026', price: 28500000, quota: 45 },
    { name: 'Haji Furoda VIP', date: '10 Mei 2027', price: 285000000, quota: 4 },
  ];

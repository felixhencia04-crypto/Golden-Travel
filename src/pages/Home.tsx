...
export default function Home() {
  ...
  return (
    <div className="font-['Montserrat',sans-serif] bg-stone-50 text-[#2F4F4F] min-h-screen selection:bg-[#C8D5B9] selection:text-[#2F4F4F]">
      ...
      {/* Hero Section */}
      <section id="hero-section" className="relative min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 overflow-hidden bg-cover bg-top bg-no-repeat pt-28 pb-16 w-full" style={{ backgroundImage: `url(${heroBg})` }}>

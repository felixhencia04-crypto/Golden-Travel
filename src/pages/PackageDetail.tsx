                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-matcha-600 font-light text-sm">
                      Pesan Anda telah kami terima. Tim Admin Golden Travel akan segera menghubungi Anda melalui WhatsApp untuk proses selanjutnya.
                    </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                    ...
                    <p className="text-xs text-center text-matcha-100 mt-4">
                      Dengan menekan tombol kirim, Anda menyetujui untuk dihubungi oleh tim Golden Travel.
                    </p>
                  </form>
                )}
              </div>
